(function (window) {
    ...
    platform.init = function (game) {
        ...
        platform.create(200,580,.3,.5);
        platform.create(200,300,.3,.5);
        platform.create(300,550,.2,.4);
        platform.create(500,500,.8,.9);
        platform.create(350,350,.5,.5);
        platform.create(700,420,.5,.5);
        /*
